	...
	grunt.initConfig({
		...
		mergesrc: {
		    main: {
		      ...
		      files: {
		    	  'src/minified-full-src.js': ['src/minified-shell.js', 'src/minified-web-full-src.js', 'src/minified-util-full-src.js']
		      }
		    }
		},
		...
		rebuildsrc: {
			normal: {
				...
				files: {
					'dist/minified-src.js':     'src/minified-full-src.js',
			...
			legacy: {
				...
				files: {
					'dist/minified-legacyie-src.js'    : 'src/minified-full-src.js',
		...
		watch: {
			  ...
			  code: {
				files: ['src/minified-web-full-src.js', 'src/minified-util-full-src.js', 'src/minified-shell.js'],
				tasks: ['code']
			  },
			  content: {
			    files: ['srcContent/**/*'],
