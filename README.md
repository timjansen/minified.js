...
smaller by an order of magnitude. The compressed size is only 7.6kb, and the gzip'd size is less than 3.4kb. 
...
<tr><td>minified.js (standard)</td><td>7.6kb</td><td>3.4kb</td></tr>
<tr><td>minified.js (no IE6/7 compatibility)</td><td>6.3kb</td><td>2.8kb</td></tr>
