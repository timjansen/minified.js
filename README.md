...
smaller by an order of magnitude. The compressed size is only 7.4kb, and the gzip'd size is less than 3.3kb. 
...
<tr><td>minified.js</td><td>45kb</td><td>7.4kb</td><td>3.3kb</td></tr>
