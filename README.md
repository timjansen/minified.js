...
smaller by an order of magnitude. The compressed size is less than 8kb, and the gzip'd size is about 3.4kb. 
...
<tr><td>minified.js (standard)</td><td>7.9kb</td><td>3.4kb</td></tr>
