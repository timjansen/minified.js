...
smaller by an order of magnitude. The compressed size is only 7.9kb, and the gzip'd size is about than 3.5kb. 
...
<tr><td>minified.js</td><td>45kb</td><td>7.9kb</td><td>3.5kb</td></tr>
