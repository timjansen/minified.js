...
smaller by an order of magnitude. The compressed size is only 8kb, and the gzip'd size is less than 3.6kb. 
...
<tr><td>minified.js</td><td>45kb</td><td>8.0kb</td><td>3.6kb</td></tr>
