...
smaller by an order of magnitude. The compressed size is 8kb, and the gzip'd size is about 3.5kb. 
...
<tr><td>minified.js (standard)</td><td>8.2kb</td><td>3.5kb</td></tr>
